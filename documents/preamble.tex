...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\newcommand{\productcodefull}{N} % Код организации + Регистрационный код
%\newcommand{\programname}{N} % Название программы
%\newcommand{\productname}{N} % Шифр (название) изделия
%\newcommand{\productnamefirst}{N}
%\newcommand{\productnamesecond}{N}
%\newcommand{\progr}{Программный комплекс <<\programname>>}% Только для спецификации!
%\title{Изделие~{\productname}\\Специальное~программное обеспечение\\Программный~комплекс\\\programname} 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\titlemodelu{2} % {} - короткий штамп, {1} - полный штамп, {2} - только перв. примен. {3} - только справ №
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
% СОГЛАСОВАНО
%%\customerrank{Начальник~N\\~} % На одной стороке
%\customerrank{Начальник\\N} % На двух строках
%\customername{\phantom{А.Б.~Заказчиков}} % \phantom - убирает видимость
%
%% УТВЕРЖДАЮ
%\chiefconstructorrank{Главный конструктор\\изделия}
%\chiefconstructorname{А.В.~Главный}
%%
